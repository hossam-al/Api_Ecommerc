    ...
    public function run(): void
    {
        ...
        $adminProducts = [
            [
                ...
                'price' => 2499.99,
                'stock' => 10,
                'category_id' => $categories->where('name_en', 'Computers')->first()->id ?? $categories->random()->id
            ],
            [
                ...
                'price' => 129.99,
                'stock' => 50,
                'category_id' => $categories->where('name_en', 'Electronics')->first()->id ?? $categories->random()->id
            ],
            [
                ...
                'price' => 349.99,
                'stock' => 25,
                'category_id' => $categories->where('name_en', 'Furniture')->first()->id ?? $categories->random()->id
            ],
            [
            ...
            [
                ...
                'price' => 159.99,
                'stock' => 60,
                'category_id' => $categories->where('name_en', 'Accessories')->first()->id ?? $categories->random()->id
            ],
            [
            ...
            [
                ...
                'price' => 59.99,
                'stock' => 200,
                'category_id' => $categories->where('name_en', 'Pet Supplies')->first()->id ?? $categories->random()->id
            ],
            [
